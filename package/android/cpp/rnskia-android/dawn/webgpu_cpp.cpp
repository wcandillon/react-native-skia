...
namespace wgpu {
    ...
    static_assert(static_cast<uint32_t>(WGSLFeatureName::ChromiumTestingUnimplemented) == WGPUWGSLFeatureName_ChromiumTestingUnimplemented, "value mismatch for WGSLFeatureName::ChromiumTestingUnimplemented");
    static_assert(static_cast<uint32_t>(WGSLFeatureName::ChromiumTestingUnsafeExperimental) == WGPUWGSLFeatureName_ChromiumTestingUnsafeExperimental, "value mismatch for WGSLFeatureName::ChromiumTestingUnsafeExperimental");
    static_assert(static_cast<uint32_t>(WGSLFeatureName::ChromiumTestingExperimental) == WGPUWGSLFeatureName_ChromiumTestingExperimental, "value mismatch for WGSLFeatureName::ChromiumTestingExperimental");
    static_assert(static_cast<uint32_t>(WGSLFeatureName::ChromiumTestingShippedWithKillswitch) == WGPUWGSLFeatureName_ChromiumTestingShippedWithKillswitch, "value mismatch for WGSLFeatureName::ChromiumTestingShippedWithKillswitch");
    static_assert(static_cast<uint32_t>(WGSLFeatureName::ChromiumTestingShipped) == WGPUWGSLFeatureName_ChromiumTestingShipped, "value mismatch for WGSLFeatureName::ChromiumTestingShipped");
    ...
    static_assert(static_cast<uint32_t>(FeatureName::Unorm16TextureFormats) == WGPUFeatureName_Unorm16TextureFormats, "value mismatch for FeatureName::Unorm16TextureFormats");
    static_assert(static_cast<uint32_t>(FeatureName::Snorm16TextureFormats) == WGPUFeatureName_Snorm16TextureFormats, "value mismatch for FeatureName::Snorm16TextureFormats");
    ...
    static_assert(static_cast<uint32_t>(FeatureName::AdapterPropertiesVk) == WGPUFeatureName_AdapterPropertiesVk, "value mismatch for FeatureName::AdapterPropertiesVk");
    static_assert(static_cast<uint32_t>(FeatureName::R8UnormStorage) == WGPUFeatureName_R8UnormStorage, "value mismatch for FeatureName::R8UnormStorage");
    static_assert(static_cast<uint32_t>(FeatureName::FormatCapabilities) == WGPUFeatureName_FormatCapabilities, "value mismatch for FeatureName::FormatCapabilities");
    static_assert(static_cast<uint32_t>(FeatureName::DrmFormatCapabilities) == WGPUFeatureName_DrmFormatCapabilities, "value mismatch for FeatureName::DrmFormatCapabilities");
    ...
    static_assert(static_cast<uint32_t>(FeatureName::SharedBufferMemoryD3D12Resource) == WGPUFeatureName_SharedBufferMemoryD3D12Resource, "value mismatch for FeatureName::SharedBufferMemoryD3D12Resource");
    static_assert(static_cast<uint32_t>(FeatureName::StaticSamplers) == WGPUFeatureName_StaticSamplers, "value mismatch for FeatureName::StaticSamplers");
    ...
    static_assert(static_cast<uint32_t>(PopErrorScopeStatus::Success) == WGPUPopErrorScopeStatus_Success, "value mismatch for PopErrorScopeStatus::Success");
    static_assert(static_cast<uint32_t>(PopErrorScopeStatus::InstanceDropped) == WGPUPopErrorScopeStatus_InstanceDropped, "value mismatch for PopErrorScopeStatus::InstanceDropped");
    ...
    static_assert(static_cast<uint32_t>(SType::AdapterPropertiesVk) == WGPUSType_AdapterPropertiesVk, "value mismatch for SType::AdapterPropertiesVk");
    ...
    static_assert(static_cast<uint32_t>(SType::DrmFormatCapabilities) == WGPUSType_DrmFormatCapabilities, "value mismatch for SType::DrmFormatCapabilities");
    ...
    static_assert(static_cast<uint32_t>(SType::SharedBufferMemoryD3D12ResourceDescriptor) == WGPUSType_SharedBufferMemoryD3D12ResourceDescriptor, "value mismatch for SType::SharedBufferMemoryD3D12ResourceDescriptor");
    static_assert(static_cast<uint32_t>(SType::StaticSamplerBindingLayout) == WGPUSType_StaticSamplerBindingLayout, "value mismatch for SType::StaticSamplerBindingLayout");
    ...
    static_assert(static_cast<uint32_t>(HeapProperty::Undefined) == WGPUHeapProperty_Undefined, "value mismatch for HeapProperty::Undefined");
    static_assert(static_cast<uint32_t>(HeapProperty::DeviceLocal) == WGPUHeapProperty_DeviceLocal, "value mismatch for HeapProperty::DeviceLocal");
    static_assert(static_cast<uint32_t>(HeapProperty::HostVisible) == WGPUHeapProperty_HostVisible, "value mismatch for HeapProperty::HostVisible");
    static_assert(static_cast<uint32_t>(HeapProperty::HostCoherent) == WGPUHeapProperty_HostCoherent, "value mismatch for HeapProperty::HostCoherent");
    static_assert(static_cast<uint32_t>(HeapProperty::HostUncached) == WGPUHeapProperty_HostUncached, "value mismatch for HeapProperty::HostUncached");
    static_assert(static_cast<uint32_t>(HeapProperty::HostCached) == WGPUHeapProperty_HostCached, "value mismatch for HeapProperty::HostCached");
