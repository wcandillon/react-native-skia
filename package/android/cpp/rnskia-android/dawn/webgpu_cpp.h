...
public:
  ...
  Future MapAsyncF(MapMode mode, size_t offset, size_t size,
...
public:
  ...
  Future RequestAdapterF(RequestAdapterOptions const *options,
...
// The operators of EnumClassBitmmasks in the dawn:: namespace need to be
// imported in the wgpu namespace for Argument Dependent Lookup.
// DAWN_IMPORT_BITMASK_OPERATORS
} // namespace wgpu

namespace dawn {
// template <> struct IsDawnBitmask<wgpu::BufferUsage> {
//   static constexpr bool enable = true;
// };

// template <> struct IsDawnBitmask<wgpu::ColorWriteMask> {
//   static constexpr bool enable = true;
// };

// template <> struct IsDawnBitmask<wgpu::HeapProperty> {
//   static constexpr bool enable = true;
// };

// template <> struct IsDawnBitmask<wgpu::MapMode> {
//   static constexpr bool enable = true;
// };

// template <> struct IsDawnBitmask<wgpu::ShaderStage> {
//   static constexpr bool enable = true;
// };

// template <> struct IsDawnBitmask<wgpu::TextureUsage> {
//   static constexpr bool enable = true;
// };
