...
import { debug as hostDebug, skHostConfig, Container } from "./native";
...
const useCanvasRef = () => useRef<SkiaView>(null);
...
export const Canvas2 = forwardRef<SkiaView, CanvasProps>(
